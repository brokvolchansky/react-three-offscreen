import { RootStore, EventManager } from '@react-three/fiber';
...
export declare function createPointerEvents(emitter: Emitter<Record<any, unknown>>): (store: RootStore) => EventManager<HTMLElement>;
